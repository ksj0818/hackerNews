...
// hashchange는 어디서 발생하나, window객체가 있음
window.addEventListener('hashchange', function (){
  ...
  ajax.open('GET', CONTENT_URL.replace('@id', id), false); // CONTENT_URL의 @id를 id로 대체해야함
  ajax.send();
...
// a 태그가 클릭 됐을 때 내가 어떤 코드를 실행해 라고 등록하는 방식은 addEventListenere() (어떤 이벤트가 발생하는지 듣고 있는 리스너를 등록)
